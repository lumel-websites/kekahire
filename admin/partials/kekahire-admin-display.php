			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<select id="kekahire-listing-selector">
							...
							<option value="grid"><?php _e( 'Grid', 'kekahire' ); ?></option>
    					</select>
				...
				<tr class="kekahire-admin-simple-listing-row">
					...
					<td>
						...
						<select id="kekahire-state-selector" multiple disabled></select>
				...
				<tr class="kekahire-admin-simple-listing-row">
					...
					<td>
						...
						<select id="kekahire-city-selector" multiple disabled></select>
